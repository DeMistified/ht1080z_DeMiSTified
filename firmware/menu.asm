...
_Menu_Visible:
	stdec	r6
						...
						//../DeMiSTify/firmware/menu.c, line 141
						//setreturn
...
l35: # 
	...
	.lipcrel	l37
		add	r7
						...
						//../DeMiSTify/firmware/menu.c, line 163
		// Offsets 0, 0
		// Have am? no, no
		// flags 42, 42
						// (a/p assign)
...
l85: # 
	...
	st	r6
						...
						//../DeMiSTify/firmware/menu.c, line 333
						// (compare) (q1 signed) (q2 signed)
...
l90: # 
						...
						//../DeMiSTify/firmware/menu.c, line 337
		// Offsets 1, 0
		// Have am? no, no
		// flags 1, 42
						// (a/p assign)
...
l86: # 
	...
	.lipcrel	l92
		add	r7
						...
						//../DeMiSTify/firmware/menu.c, line 342
						// (test)
						// (obj to tmp) flags 2 type 3
						// matchobj comparing flags 2 with 1
						//static not varadr
...
l92: # 
	...
	.lipcrel	l97
		add	r7
						...
						//../DeMiSTify/firmware/menu.c, line 351
						// (compare) (q1 signed) (q2 signed)
						// (obj to r0) flags 2 type 3
						// matchobj comparing flags 2 with 1
						//static not varadr
...
l100: # 
						...
						//../DeMiSTify/firmware/menu.c, line 355
		// Offsets 1, 0
		// Have am? no, no
		// flags 1, 42
						// (a/p assign)
...
l105: # 
						...
						//../DeMiSTify/firmware/menu.c, line 373
						// (test)
						// (obj to tmp) flags 42 type 3
						// reg r5 - only match against tmp
	mt	r5
	...
	.lipcrel	l108
		add	r7
						...
						//../DeMiSTify/firmware/menu.c, line 374
		// Offsets 0, 0
		// Have am? no, no
		// flags 2, 4a
						// (a/p assign)
...
l108: # 
						...
						//../DeMiSTify/firmware/menu.c, line 376
						// (test)
						// (obj to tmp) flags 2 type 3
						//static not varadr
						//statictotemp (FIXME - make PC-relative?)
	...
	.lipcrel	l110
		add	r7
						...
						//../DeMiSTify/firmware/menu.c, line 378
		// Offsets 0, 0
		// Have am? no, no
		// flags 2, 4a
						// (a/p assign)
	...
	add	r7
						...
						//../DeMiSTify/firmware/menu.c, line 379
		// Offsets 0, 0
		// Have am? no, no
		// flags 1, 4a
						// (a/p assign)
...
_Menu_Message:
	...
	mr	r5
						...
						//../DeMiSTify/firmware/menu.c, line 388
						// (bitwise/arithmetic) 	//ops: 2, 0, 2
						// WARNING - q1 and target collision - check code for correctness.
						// (obj to tmp) flags 1 type a
						// matchobj comparing flags 1 with 42
	...
	st	r6
						...
						//../DeMiSTify/firmware/menu.c, line 389
						// (test)
	...
	.lipcrel	l115
		add	r7
						...
						//../DeMiSTify/firmware/menu.c, line 391
	...
	st	r3
						...
						//../DeMiSTify/firmware/menu.c, line 392
		// Offsets 0, 0
		// Have am? no, no
		// flags 2, 4a
						// (a/p assign)
	...
	add	r7
						...
						//../DeMiSTify/firmware/menu.c, line 393
						// Z disposable
		// Offsets 0, 0
		// Have am? no, yes
		// flags 62, 6a
