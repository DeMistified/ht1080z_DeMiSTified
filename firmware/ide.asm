...
l166:
	...
	mr	r1
						...
						//../DeMiSTify/firmware/ide.c, line 540
						// (test)
	...
	.lipcrel	l170
		add	r7
						...
						//../DeMiSTify/firmware/ide.c, line 541
		// Offsets 1, 0
		// Have am? no, no
		// flags 1, 42
						// (a/p assign)
...
l170: # 
						...
						//../DeMiSTify/firmware/ide.c, line 543
						// (test)
						// (obj to tmp) flags 2 type 103
						// extern
	.liabs	_hdf, 44
	...
	.lipcrel	l172
		add	r7
						...
						//../DeMiSTify/firmware/ide.c, line 544
						// (bitwise/arithmetic) 	//ops: 2, 0, 2
						// WARNING - q1 and target collision - check code for correctness.
						// (obj to tmp) flags 1 type 3
						// matchobj comparing flags 1 with 2
...
l172: # 
						...
						//../DeMiSTify/firmware/ide.c, line 554
		// Offsets 517, -48
		// Have am? no, no
		// flags 1, 21
						// (a/p assign)
	...
	st	r0
						...
						//../DeMiSTify/firmware/ide.c, line 555
		// Offsets 250, -44
		// Have am? no, no
		// flags 1, 21
						// (a/p assign)
	...
	st	r0
						...
						//../DeMiSTify/firmware/ide.c, line 556
						// Q1 disposable
						//FIXME convert
						// (convert - reducing type 3 to 503
						// (prepobj r0)
	...
	st	r0
						...
						//../DeMiSTify/firmware/ide.c, line 557
		// Offsets 4, -48
		// Have am? no, no
		// flags 1, 21
						// (a/p assign)
...
_OpenHardfile:
	...
	.lipcrel	l176
		add	r7
						...
						//../DeMiSTify/firmware/ide.c, line 566
		// Offsets 0, 0
		// Have am? no, no
		// flags 42, 4a
						// (a/p assign)
...
_HandleHDD:
	...
	add	r6
						...
						//../DeMiSTify/firmware/ide.c, line 579
						//call
						//pcreltotemp
	.lipcrel	l4 // Static 
	add	r7
	...
	mr	r1
						...
						//../DeMiSTify/firmware/ide.c, line 581
						// (bitwise/arithmetic) 	//ops: 2, 0, 2
						// WARNING - q1 and target collision - check code for correctness.
						// (obj to tmp) flags 1 type 3
						// matchobj comparing flags 1 with 4a
	...
	st	r0
						...
						//../DeMiSTify/firmware/ide.c, line 584
		// Offsets 128, -44
		// Have am? no, no
		// flags 1, 21
						// (a/p assign)
	...
	st	r0
						...
						//../DeMiSTify/firmware/ide.c, line 586
		// Offsets 0, -44
		// Have am? no, no
		// flags 1, 21
						// (a/p assign)
...
l223: # 
	...
	add	r7
						...
						//../DeMiSTify/firmware/ide.c, line 605
						//pcreltotemp
	.lipcrel	l222
	add	r7
l186: # 

						//../DeMiSTify/firmware/ide.c, line 607
						//FIXME convert
						//Converting to wider type...
						//But unsigned, so no need to extend
						// (prepobj r4)
	...
	.lipcrel	l188
		add	r7
						...
						//../DeMiSTify/firmware/ide.c, line 608
						// (a/p push)
						// a: pushed 0, regnames[sp] r6
						// (obj to tmp) flags 42 type 3
						// matchobj comparing flags 42 with 1
